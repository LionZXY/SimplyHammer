...
{
    private List<api.api.spell.ILeftClickEffect> leftClickEffectList;
    private List<api.api.spell.IRightClickEffect> rightClickEffectList;
    private List<api.api.spell.IToolUpdateEffect> toolUpdateEffectList;
    private List<api.api.spell.IOnSummonTool> toolSummonEffectList;
    private List<api.api.spell.IOnBanishTool> toolBanishEffectList;
    private List<IOnBreakBlock> breakBlockEffectList;
    private List<api.api.spell.IItemManipulator> itemManipulatorEffectList;
    private List<IDigAreaEffect> digAreaEffectList;
    private List<api.api.spell.ISpecialDamageEffect> specialDamageEffectList;
    ...
    public ItemStack prepareTool(ItemStack crystalStack, World world)
    {
        ...
        {
            this.addToolString("SilkTouch", "Silk Touch" + " " + api.api.spell.APISpellHelper.getNumeralForInt(1));
        }

        if (this.getFortuneLevel() > 0)
        {
            this.addToolString("Fortune", "Fortune" + " " + api.api.spell.APISpellHelper.getNumeralForInt(this.getFortuneLevel()));
        }
    ...
    public static SpellParadigmTool getParadigmForEffectArray(List<api.api.spell.SpellEffect> effectList)
    {
        SpellParadigmTool parad = new SpellParadigmTool();

        for (api.api.spell.SpellEffect eff : effectList)
        {
    ...
    public void addLeftClickEffect(api.api.spell.ILeftClickEffect eff)
    {
        if (eff != null)
        {
    ...
    public void addRightClickEffect(api.api.spell.IRightClickEffect eff)
    {
        if (eff != null)
        {
    ...
    public void addUpdateEffect(api.api.spell.IToolUpdateEffect eff)
    {
        if (eff != null)
        {
    ...
    public void addToolSummonEffect(api.api.spell.IOnSummonTool eff)
    {
        if (eff != null)
        {
    ...
    public void addToolBanishEffect(api.api.spell.IOnBanishTool eff)
    {
        if (eff != null)
        {
    ...
    public void addItemManipulatorEffect(api.api.spell.IItemManipulator eff)
    {
        if (eff != null)
        {
    ...
    public void addSpecialDamageEffect(api.api.spell.ISpecialDamageEffect eff)
    {
        if (eff != null)
        {
    ...
    {
        int total = 0;
        for (api.api.spell.ILeftClickEffect effect : this.leftClickEffectList)
        {
    ...
    {
        int total = 0;
        for (api.api.spell.IRightClickEffect effect : this.rightClickEffectList)
        {
    ...
    {
        int total = 0;
        for (api.api.spell.IToolUpdateEffect effect : this.toolUpdateEffectList)
        {
    ...
    {
        int total = 0;
        for (api.api.spell.IOnSummonTool effect : this.toolSummonEffectList)
        {
    ...
    {
        int total = 0;
        for (api.api.spell.IOnBanishTool effect : this.toolBanishEffectList)
        {
    ...
    public List<ItemStack> handleItemList(ItemStack toolStack, List<ItemStack> items)
    {
        ...
        for (api.api.spell.IItemManipulator eff : this.itemManipulatorEffectList)
        {
    ...
    public float getAddedDamageForEntity(Entity entity)
    {
        ...
        for (api.api.spell.ISpecialDamageEffect effect : this.specialDamageEffectList)
        {
