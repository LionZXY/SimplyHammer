...
import api.api.alchemy.energy.ReagentRegistry;
...
public class APISpellHelper 
{
	...
	public static api.api.alchemy.energy.Reagent getPlayerReagentType(EntityPlayer player)
	{
		NBTTagCompound data = APISpellHelper.getPersistentDataTag(player);
	...
	public static void setPlayerReagentType(EntityPlayer player, api.api.alchemy.energy.Reagent reagent)
	{
