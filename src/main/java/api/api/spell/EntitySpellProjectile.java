...
public class EntitySpellProjectile extends Entity implements IProjectile
{
    ...
    public List<api.api.spell.IProjectileImpactEffect> impactList = new ArrayList();
    private boolean penetration = false;
    public List<IProjectileUpdateEffect> updateEffectList = new ArrayList();
    public List<api.api.spell.SpellEffect> spellEffectList = new LinkedList();
...
//            if (var18.equals(Block.getBlockById(inTile)) && var19 == inData)
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (api.api.spell.SpellEffect eff : spellEffectList)
        {
...
//        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        List<api.api.spell.SpellEffect> spellEffectList = new LinkedList();
        for (int i = 0; i < tagList.tagCount(); i++)
        {
            NBTTagCompound tag = tagList.getCompoundTagAt(i);

            api.api.spell.SpellEffect eff = api.api.spell.SpellEffect.getEffectFromTag(tag);
            if (eff != null)
            {
...
//        }
    ...
    public void setImpactList(List<api.api.spell.IProjectileImpactEffect> list)
    {
    ...
    private void performEntityImpactEffects(Entity mop)
    {
        if (impactList != null)
        {
            for (api.api.spell.IProjectileImpactEffect impactEffect : impactList)
            {
    ...
    public void setSpellEffectList(List<api.api.spell.SpellEffect> list)
    {
