...
public abstract class ComplexSpellEffect
{
	...
	public final api.api.spell.ComplexSpellModifier modifier;
	
	protected int powerEnhancement;
    protected int costEnhancement;
    protected int potencyEnhancement;
	
	public ComplexSpellEffect(ComplexSpellType type, api.api.spell.ComplexSpellModifier modifier)
	{
		this.type = type;
		this.modifier = modifier;
	}
	
	public ComplexSpellEffect(ComplexSpellType type, api.api.spell.ComplexSpellModifier modifier, int power, int cost, int potency)
	{
		this(type, modifier);
	...
	public api.api.spell.ComplexSpellModifier getModifier()
	{
