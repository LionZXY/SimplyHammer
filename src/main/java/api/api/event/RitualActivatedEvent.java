...
public class RitualActivatedEvent extends RitualEvent
{
	...
	public RitualActivatedEvent(api.api.rituals.IMasterRitualStone mrs, String ownerKey, String ritualKey, EntityPlayer player, ItemStack activationCrystal, int crystalTier)
	{
