...
import api.api.tile.IBloodAltar;
...
public class PlayerSacrificeHandler 
{
	...
	{
		return api.api.spell.APISpellHelper.getCurrentIncense(player);
	}
	
	public static void setPlayerIncense(EntityPlayer player, float amount)
	{
		api.api.spell.APISpellHelper.setCurrentIncense(player, amount);
	}
