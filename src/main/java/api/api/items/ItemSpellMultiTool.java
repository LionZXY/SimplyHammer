...
import api.api.spell.APISpellHelper;
import api.api.spell.SpellEffect;
...
public class ItemSpellMultiTool extends Item
{
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        api.api.spell.SpellParadigmTool parad = this.loadParadigmFromStack(par1ItemStack);
    ...
    {
        api.api.spell.SpellParadigmTool parad = this.loadParadigmFromStack(stack);
...
//            world.playAuxSFX(2001, x, y, z, Block.getIdFromBlock(block) + (meta << 12));
    ...
    public void onUpdate(ItemStack toolStack, World world, Entity par3Entity, int par4, boolean par5)
    {
        ...
        api.api.spell.SpellParadigmTool parad = this.loadParadigmFromStack(toolStack);
    ...
    public api.api.spell.SpellParadigmTool loadParadigmFromStack(ItemStack container)
    {
        if (!container.hasTagCompound())
        {
            container.setTagCompound(new NBTTagCompound());
        ...
        return api.api.spell.SpellParadigmTool.getParadigmForEffectArray(spellEffectList);
    }
