...
public class ShapelessBloodOrbRecipe implements IRecipe
{
    ...
    public ShapelessBloodOrbRecipe(ItemStack result, Object... recipe)
    {
        ...
        {
            if (in instanceof api.api.items.interfaces.IBloodOrb)
            { //If the item is an instanceof IBloodOrb then save the level of the orb
                input.add(((api.api.items.interfaces.IBloodOrb) in).getOrbLevel());
            }
            else if (in instanceof ItemStack)
            {
                if (((ItemStack)in).getItem() instanceof api.api.items.interfaces.IBloodOrb)
                {
                    input.add(((api.api.items.interfaces.IBloodOrb) ((ItemStack)in).getItem()).getOrbLevel());
                }
